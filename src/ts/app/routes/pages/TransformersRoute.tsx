...
export const TransformersRoute: React.FC = () => {
  ...
  const [selectedTask, setSelectedTask] =
    useState<TaskType>("sentiment-analysis");
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experiment with multiple AI tasks using Hugging Face
              Transformers.js directly in your browser!
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                {selectedTask === "question-answering" && (
                  <p className="mt-2 text-sm text-gray-500">
                    The system will ask "What is the main topic?" about your
                    text.
                  </p>
                )}
              </div>
              ...
              <div className="flex justify-center">
                ...
                >
                  {loading
                    ? "Processing..."
                    : `Run ${selectedTask === "sentiment-analysis" ? "Analysis" : selectedTask === "text-generation" ? "Generation" : selectedTask === "feature-extraction" ? "Extraction" : "Q&A"}`}
                </button>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <p className="text-blue-800 text-sm leading-relaxed">
                Transformers.js brings state-of-the-art machine learning to your
                browser. Models are downloaded on-demand and cached locally for
                faster subsequent use. This demo showcases multiple NLP tasks
                including sentiment analysis, text generation, feature
