...
export const SpectrumRoute: React.FC<SpectrumRouteProps> = ({
  ...
  const [fastSnapshotShowStats, setFastSnapshotShowStats] = useState(
  ...
  const setShowStatsSpectrum = setFastSnapshotShowStats;
  const setShowStatsWaterfall = setFastSnapshotShowStats;
