...
export const HOTSPOT_COLOR_MULTISELECT =
  THEME_TOKENS.colors.dark.hotspotMultiselect;
...
export const HOTSPOT_CONTROL_PANEL_WIDTH =
  THEME_TOKENS.layout.hotspotControlPanelWidth;
export const HOTSPOT_CONTROL_PANEL_PADDING =
  THEME_TOKENS.layout.hotspotControlPanelPadding;
...
export const POPOVER_ICON_BACKGROUND =
  THEME_TOKENS.colors.dark.popoverIconBackground;
...
export const POPOVER_ICON_HOVER_BACKGROUND =
  THEME_TOKENS.colors.dark.popoverIconHoverBackground;
export const POPOVER_ICON_HOVER_COLOR =
  THEME_TOKENS.colors.dark.popoverIconHoverColor;
...
export const SECTION_TITLE_AFTER_COLOR =
  THEME_TOKENS.colors.dark.sectionTitleAccent;
...
export const RANGE_TRACK_BACKGROUND =
  THEME_TOKENS.colors.dark.rangeTrackBackground;
