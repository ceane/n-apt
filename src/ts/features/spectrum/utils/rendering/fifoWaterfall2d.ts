...
export const createFifoWaterfall2DRenderer = (): FifoWaterfall2DRenderer => {
  ...
  return {
    draw: (
      ...
      // Match the WebGPU renderer's stepped zoom behavior. Browser-default
      // interpolation turns discrete FFT bins into broad blurred bands.
      const isSteps = zoom >= 3;
      context.imageSmoothingEnabled = !isSteps;
      sourceContext.imageSmoothingEnabled = !isSteps;
