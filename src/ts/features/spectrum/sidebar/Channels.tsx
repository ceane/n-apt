...
import { Collapsible, Tooltip } from "@n-apt/ui";
...
export const Channels: React.FC<ChannelsProps> = ({
  ...
  const iqDataRateMBps = formatDataRate(
    bandwidthMBps * 1_000_000 * BYTES_PER_IQ_SAMPLE.u8,
  );
        ...
        <ChannelsSpectrumGrid>
          {Array.isArray(liveFramesToUse) && liveFramesToUse.length > 0 ? (
            liveFramesToUse.map((frame) => {
              ...
              const wholeChannelFrame = resolveWholeChannelFrame({
              ...
              const frameUsesWholeChannelRange =
                wholeChannelFrame.isWholeChannel;
              const sliderSampleRateHz = frameUsesWholeChannelRange
                ? wholeChannelFrame.sampleRateHz
                : !supportsWholeChannelDisplay &&
                    typeof channelSampleRateHz === "number" &&
                    Number.isFinite(channelSampleRateHz) &&
              ...
              return (
                <ReduxFrequencyRangeSlider
                  ...
                  isWholeChannelMode={frameUsesWholeChannelRange}
            ...
            <Collapsible title="Channel Description">
              ...
              <Collapsible title="More...">
                <ActiveChannelBandwidthList>
                  ...
                  <br />5 mins ={" "}
                  <MonoValue>{formatDataTotal(minutes5MB * 1_000_000)}</MonoValue>
                  <br />1 hour = <MonoValue>{formatDataTotal(hourMB * 1_000_000)}</MonoValue>
                  <br />
                  24 hours = <MonoValue>{formatDataTotal(dayMB * 1_000_000)}</MonoValue>
                </ActiveChannelBandwidthList>
              </Collapsible>
            </Collapsible>
          </ActiveChannelInfoBox>
                  ...
                  <ReduxFrequencyRangeSlider
                    ...
                    isWholeChannelMode={
                      resolveWholeChannelFrame({
                        ...
                        wholeChannelMode: isWholeChannelMode,
                        sampleRateHz: channelSampleRateHz,
                        channelBounds: { min: ch.min_hz, max: ch.max_hz },
                      }).isWholeChannel
                    }
                    forceFullWidth={isWholeChannelMode}
                    allowWideSampleRateOverscan
