...
import { PretextVFODisplay } from "@n-apt/learn/pretext/PretextVFODisplay";
import { PretextGridOverlay } from "@n-apt/learn/pretext/PretextGridOverlay";
import { PretextDBScale } from "@n-apt/learn/pretext/PretextDBScale";
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "20px", fontSize: "14px", opacity: 0.8 }}>
        ...
        <p>
          • Current range: {fftMin} to {fftMax} {powerScale}
        </p>
      </div>
    </div>
  );
