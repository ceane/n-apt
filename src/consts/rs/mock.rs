...
pub const MOCK_PERSISTENT_SIGNALS: usize = 128; // Number of consistent signal patterns
...
pub const MOCK_SIGNAL_APPEARANCE_CHANCE: f32 = 0.02; // Chance for new signal to appear
