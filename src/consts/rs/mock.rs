...
pub const MOCK_PERSISTENT_SIGNALS: usize = 8; // Number of consistent signal patterns
...
pub const MOCK_STRONG_SIGNAL_MAX: f32 = 60.0;
pub const MOCK_MEDIUM_SIGNAL_MIN: f32 = 20.0;
pub const MOCK_MEDIUM_SIGNAL_MAX: f32 = 35.0;
pub const MOCK_WEAK_SIGNAL_MIN: f32 = 5.0;
pub const MOCK_WEAK_SIGNAL_MAX: f32 = 15.0;
...
pub const MOCK_SIGNAL_STRENGTH_VARIATION: f32 = 2.0; // dB variation in signal strength
