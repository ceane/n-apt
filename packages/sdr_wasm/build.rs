fn main() {
    ...
    // This assumes rtl-sdr is installed system-wide
    // On macOS with Homebrew: /usr/local/include/rtl-sdr
    // On Ubuntu: /usr/include/rtl-sdr
    // On Windows: might need to specify path manually
    ...
    // For WASM compilation, we'll skip RTL-SDR linking
    #[cfg(target_arch = "wasm32")]
    {
        println!("cargo:warning=RTL-SDR not available for WASM - using mock implementation");
    }
}
