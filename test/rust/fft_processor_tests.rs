use n_apt_backend::fft::processor::{FFTProcessor, EnhancedFFTConfig, WindowType, bin_to_freq, frequency_resolution, apply_window, detect_peaks, zoom_fft, calculate_snr, find_peak_frequency};
...
mod tests {
    ...
    fn test_window_functions() {
        ...
        assert!(samples.iter().all(|&x: &f32| (x - 1.0).abs() < f32::EPSILON));
    }
