...
mod integration_tests {
    ...
    async fn test_capture_with_valid_sample_rate() -> Result<()> {
        ...
        assert_eq!(capture_result.hardware_sample_rate_hz, DEFAULT_SAMPLE_RATE as f64);
    ...
    async fn test_capture_metadata_contains_correct_sample_rate() -> Result<()> {
        ...
        assert_eq!(capture_result.hardware_sample_rate_hz, DEFAULT_SAMPLE_RATE as f64);
        assert_eq!(capture_result.overall_capture_sample_rate_hz, DEFAULT_SAMPLE_RATE as f64);
    ...
    async fn test_sample_rate_persistence_across_capture_cycles() -> Result<()> {
        ...
        assert_eq!(result1.hardware_sample_rate_hz, result2.hardware_sample_rate_hz);
...
mod error_handling_tests {
    ...
    async fn test_whole_sample_capture_produces_single_hop() -> Result<()> {
        ...
        let result = processor.start_capture(capture_request);
        assert!(result.is_ok(), "whole_sample capture should start successfully");
