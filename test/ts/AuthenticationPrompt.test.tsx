...
describe("AuthenticationPrompt Component", () => {
  ...
  it("should handle password submission", async () => {
    ...
    render(<AuthenticationPrompt {...defaultProps} onPasswordSubmit={mockPasswordSubmit} />)
  ...
  it("should handle passkey authentication", () => {
    ...
    render(<AuthenticationPrompt {...defaultProps} onPasskeyAuth={mockPasskeyAuth} hasPasskeys={true} />)
  ...
  it("should handle passkey registration", () => {
    ...
    render(<AuthenticationPrompt {...defaultProps} onRegisterPasskey={mockRegisterPasskey} hasPasskeys={false} />)
  ...
  it("should show different message for ready state without passkeys", () => {
    render(<AuthenticationPrompt {...defaultProps} hasPasskeys={false} />)
    expect(screen.getByText("Enter password to authenticate and start streaming")).toBeInTheDocument()
  })
})
