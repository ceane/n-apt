...
describe("GPUMemoryManager", () => {
  ...
  describe("Memory Tracking", () => {
    test("should track buffer allocations", () => {
      ...
      const buffer = memoryManager.createOptimizedBuffer(
        1024,
    ...
    test("should track texture allocations", () => {
      ...
      const texture = memoryManager.createOptimizedTexture(
        textureDescriptor,
        "test-texture",
      );
    ...
    test("should align buffer sizes to 256 bytes", () => {
      ...
      memoryManager.createOptimizedBuffer(
        300,
        GPUBufferUsage.VERTEX,
        "test-buffer",
      );
  ...
  describe("Memory Management", () => {
    test("should handle resource release", () => {
      ...
      const _buffer = memoryManager.createOptimizedBuffer(
        1024,
        GPUBufferUsage.VERTEX,
        "test-buffer",
      );
