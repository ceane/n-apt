...
describe('InfoPopover Component', () => {
  ...
  it('should handle long content', () => {
    const longContent = 'This is a very long content that should wrap properly and be displayed correctly in the popover without breaking the layout or causing overflow issues.';
