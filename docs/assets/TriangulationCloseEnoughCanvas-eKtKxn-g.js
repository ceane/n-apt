import{a as T,f as U,g as A,i as C,o,t as D}from"./index-CNyOZayG.js";import{In as E,Jn as b,Yn as v,a as R,ct as g,fr as W,n as O,o as h,s as y,t as s,x as N}from"./CanvasText-CMkeTbEM.js";var l=A(U()),f=e=>e===Object(e)&&!Array.isArray(e)&&typeof e!="function";function p(e,i){const n=y(r=>r.gl),a=h(v,f(e)?Object.values(e):e);return(0,l.useLayoutEffect)(()=>{i?.(a)},[i]),(0,l.useEffect)(()=>{if("initTexture"in n){let r=[];Array.isArray(a)?r=a:a instanceof b?r=[a]:f(a)&&(r=Object.values(a)),r.forEach(c=>{c instanceof b&&n.initTexture(c)})}},[n,a]),(0,l.useMemo)(()=>{if(f(e)){const r={};let c=0;for(const u in e)r[u]=a[c++];return r}else return a},[e,a])}p.preload=e=>h.preload(v,e);p.clear=e=>h.clear(v,e);var t="/Users/ceanelamerez/Documents/codescratch.nosync/n-apt/src/md-preview/components/canvas/TriangulationCloseEnoughCanvas.tsx",X=C("body-attenuation-character.png"),m={width:2.91,height:5.32},d={centerX:0,centerY:-.38,radiusX:1.08,radiusY:2.22},Y=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
